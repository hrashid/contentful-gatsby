module.exports = {
  siteTitle: 'sd',
  siteTitleAlt: 'my site', // This allows an alternative site title for SEO schema.
  publisher: 'Publisher named GCN', // Organization name used for SEO schema
  siteDescription:
    'sssser template to build amazing static websites with Gatsby, Contentful and Netlify',
  ...
  author: 'sdcr', // Author for RSS author segment and SEO schema
